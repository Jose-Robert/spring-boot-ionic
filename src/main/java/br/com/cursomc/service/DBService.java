...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException  {
		...
		Cliente cli1 = new Cliente(null, "José Robert", "robertspfc10@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("admin"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Bryan Calleri", "bryan.calleri@gmail.com", "11751327485", TipoCliente.PESSOAFISICA, pe.encode("1234"));
		cli2.getTelefones().addAll(Arrays.asList("986670767","986353090"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Airton Senna", "38", "Sala 202", "Recanto do Poço", "58101105", cli2, c2);
